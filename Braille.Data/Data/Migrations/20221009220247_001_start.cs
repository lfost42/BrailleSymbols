    ...
    public partial class _001_start : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsciiCharacters", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrailleSymbols", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BrailleSymbols_AsciiCharacters_AsciiCharacterId",
                        column: x => x.AsciiCharacterId,
                        principalTable: "AsciiCharacters",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrailleSymbols_AsciiCharacterId",
                table: "BrailleSymbols",
                column: "AsciiCharacterId");
        }
